...
Public Sub GenerateRoadmap()
    ...
    MsgBox "Roadmap generated across " & pages.Count & " slide(s).", vbInformation
    Exit Sub
Fail:
...
Private Sub DrawPage(sld As Object, page As Collection, s As TSettings, pageNo As Long, _
    ...
    ' ---- Footer page number ----
    If pageCount > 1 Then
        AddText sld, SLIDE_W - 160, SLIDE_H - FOOTER_H, 150, 12, _
                "Slide " & pageNo & " of " & pageCount, 8, False, RGBlong(150, 170, 205), ppAlignRight, 0
    End If
End Sub
